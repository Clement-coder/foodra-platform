...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "profile.user": "User",
    "profile.signUpMethod": "Sign Up Method",
  ...
  yo: {
    ...
    "profile.location": "Ibùdó",
    "profile.accountType": "Irú Àkọọ́lẹ̀",
    "profile.user": "Òǹlò",
    "profile.signUpMethod": "Ọ̀nà Ìforúkọsílẹ̀",
  ...
  ha: {
    ...
    "profile.accountType": "Nau'in Asusun",
    "profile.user": "Mai Amfani",
    "profile.signUpMethod": "Hanyar Rajista",
  ...
  ig: {
    ...
    "profile.email": "Email",
    "profile.location": "Ebe",
    "profile.accountType": "Ụdị Akaụntụ",
    "profile.user": "Onye Ọrụ",
    "profile.signUpMethod": "Ụzọ Ndebanye Aha",
    "profile.signOut": "Pụọ",
