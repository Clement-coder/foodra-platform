...
export const sampleProducts: Product[] = [
  {
    ...
    farmerAvatar: generateAvatarUrl("user-1"),
  ...
  },
  {
    ...
    farmerAvatar: generateAvatarUrl("user-2"),
    createdAt: new Date().toISOString(),
  },
  {
    id: "prod-3",
    ...
    farmerAvatar: generateAvatarUrl("user-3"),
    createdAt: new Date().toISOString(),
  },
  {
    id: "prod-4",
    ...
    farmerAvatar: generateAvatarUrl("user-4"),
    createdAt: new Date().toISOString(),
  },
  {
    id: "prod-5",
    ...
    farmerAvatar: generateAvatarUrl("user-5"),
    createdAt: new Date().toISOString(),
  },
  {
    id: "prod-6",
    ...
    farmerAvatar: generateAvatarUrl("user-6"),
    createdAt: new Date().toISOString(),
  }
