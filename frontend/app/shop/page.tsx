...
function ShopPage() {
  ...
  const handleConfirmPayment = () => {
    ...
    setTimeout(() => {
      ...
      saveToLocalStorage("foodra_cart", [])
  ...
  return (
    <div className="container mx-auto px-4 py-12">
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardContent className="p-6">
              ...
              <Button onClick={handleProceedToCheckout} className="w-full bg-[#118C4C] hover:bg-[#0d6d3a] text-white mb-3" size="lg">
                Proceed to Checkout
              </Button>
      ...
      <Modal
        ...
        title={paymentSuccess ? "Payment Successful!" : "Confirm Your Order"}
      >
        {isProcessingPayment ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">Your order has been successfully placed and will be processed shortly.</p>
            <Button onClick={() => setIsCheckoutModalOpen(false)} className="bg-[#118C4C] hover:bg-[#0d6d3a] text-white">
              Continue Shopping
            </Button>
          </div>
        ) : (
          <>
            <div className="space-y-3 mb-6">
              {cart.map((item) => (
                <div key={item.productId} className="flex justify-between items-center border-b border-border pb-2 last:border-b-0">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              By confirming, you agree to purchase these items. Payment will be processed securely.
            </p>
            <Button onClick={handleConfirmPayment} className="w-full bg-[#118C4C] hover:bg-[#0d6d3a] text-white" size="lg">
              Confirm Payment
            </Button>
          </>
        )}
